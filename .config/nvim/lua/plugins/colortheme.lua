        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              ['@markup.heading.1.tsx'] = { fg = colors.text },
              ['@markup.heading.2.tsx'] = { fg = colors.text },
              ['@markup.heading.3.tsx'] = { fg = colors.text },
              ['@markup.heading.4.tsx'] = { fg = colors.text },
              ['@markup.heading.5.tsx'] = { fg = colors.text },
              ['@markup.heading.6.tsx'] = { fg = colors.text },
              ['@markup.heading.1.javascript'] = { fg = colors.text },
              ['@markup.heading.2.javascript'] = { fg = colors.text },
              ['@markup.heading.3.javascript'] = { fg = colors.text },
              ['@markup.heading.4.javascript'] = { fg = colors.text },
              ['@markup.heading.5.javascript'] = { fg = colors.text },
              ['@markup.heading.6.javascript'] = { fg = colors.text },
            }
          end,
        },
      }
